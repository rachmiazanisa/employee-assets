      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="icon_document_alt"></i>Smartphone</li>
          </ol>
        </div>
       </div>
              <!-- Form validations -->              
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?php echo site_url('welcome/insertAsetIT') ?>" novalidate="novalidate">
                                     ...
                                     <label for="cname" class="control-label col-lg-2">ID Detail Aset <span class="required">*</span>
                                      ...
                                      <div class="form-group">
                                          <label for="cname" class="control-label col-lg-2">Merk<span class="required"></span>
                                          </label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="MSmartphone" minlength="5" type="text" required="" placeholder="Merk">
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">RAM<span class="required"></span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cemail" type="text" name="ramSmartphone" required="" placeholder="RAM">
                                          </div>
                                      </div>

                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">Memory<span class="required"></span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="curl" type="text" name="memory" placeholder="Memory Internal">
                                          </div>
                                      </div>

                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">Sistem Operasi<span class="required"></span></label>
                                            <div class="col-lg-10">
                                              <input class="form-control " id="curl" type="text" name="ossmartphone" placeholder="Sistem Operasi">
                                            </div>
                                      </div>                                      

                    <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">Kamera<span class="required"></span></label>
                                            <div class="col-lg-10">
                                              <input class="form-control " id="curl" type="text" name="kamera" placeholder="Contoh XX MP">
                                            </div>
                                      </div>                                      

                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">Ukuran Layar<span class="required"></span></label>
                                            <div class="col-lg-10">
                                              <input class="form-control " id="curl" type="text" name="layar" placeholder="Contoh XX Inch">
                                            </div>
                                      </div>
                                      <?php $_SESSION['HP'] ='1';?>
                                      <div class="form-group">
