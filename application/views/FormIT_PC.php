      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="icon_document_alt"></i>PC / Laptop</li>
          </ol>
        </div>
       </div>
              <!-- Form validations -->              
                        ...
                        <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?php echo site_url('welcome/insertAsetIT') ?>" novalidate="novalidate" >
                            ...
                            <div class="form-group ">
                                <label for="cemail" class="control-label col-lg-2">Merk<span class="required">*</span></label>
                                    <div class="col-lg-10">
                                       <input class="form-control " id="cemail" type="text" name="merkPC" required="">
                                    </div>
                            </div>
                            ...
                            <div class="form-group ">
                                <label for="cemail" class="control-label col-lg-2">RAM<span class="required">*</span></label>
                                    <div class="col-lg-10">
                                       <input class="form-control " id="cemail" type="text" name="ramPC" required="">
                                    </div>
                            </div>

                <div class="form-group ">
                                <label for="cemail" class="control-label col-lg-2">Processor<span class="required">*</span></label>
                                    <div class="col-lg-10">
                                       <input class="form-control " id="cemail" type="text" name="processor" required="">
                                    </div>
                            </div>

                            <div class="form-group ">
                                <label for="cemail" class="control-label col-lg-2">Harddisk<span class="required">*</span></label>
                                    <div class="col-lg-10">
                                       <input class="form-control " id="cemail" type="text" name="harddisk" required="">
                                    </div>
                            </div>

                              <div class="form-group ">
                                <label for="cemail" class="control-label col-lg-2">Sistem Operasi<span class="required">*</span></label>
                                    <div class="col-lg-10">
                                       <input class="form-control " id="cemail" type="text" name="osPC" required="">
                                    </div>
                            </div>
                            <?php $_SESSION['PC']='1'; ?>
                            <div class="form-group">
